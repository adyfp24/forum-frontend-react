  ...
  return (
    <div>
        <aside className="hidden sm:flex sm:flex-col h-screen">
          <a href="#" className="inline-flex items-center justify-center h-20 w-40 bg-purple-600 hover:bg-purple-500 focus:bg-purple-500">
            <h1 className='text-white font-semibold text-xl'>IlkomerZ</h1>
          </a>
